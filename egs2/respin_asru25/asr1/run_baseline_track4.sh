...
asr_config="conf/tuning/train_ssl_asr_conformer_transformer_e8_linear1024_bs6M_gacc1.yaml"
infer_config="conf/tuning/decode_transformer.yaml"
asr_tag="ssl_multilingual${suffix:+_$suffix}_con_e8_lin1024_bs6M_gacc1_ctc03"
asr_task="asr"
aux_tag=""
...
if [ -f "${model_ckpt}" ] && [ ! -f "${hyp}" ]; then
    ...
    ./asr_respin.sh \
        ...
        --skip_upload_hf false \
        --tag "${lang_tag}" \
        --hf_repo "saurabhk0322/respin_asru25_track4"
else
